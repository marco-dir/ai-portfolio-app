...
// Moderato Portfolio Sheet ID
const SHEET_ID = '1ZGxOR68PqQIQTiJ2yAbepNfV-uUw3dWWZ3V5lw323X8'
...
export async function GET(request: Request) {
    ...
    try {
        ...
        console.log(`[Moderate Portfolio] Fetching CSV from: ${csvUrl}`)
        ...
        if (!response.ok) {
            console.error(`[Moderate Portfolio] Fetch failed with status: ${response.status}`)
        ...
        console.log('[Moderate Portfolio] Headers:', headers)
        ...
        console.error('[Moderate Portfolio] API Error:', error)
