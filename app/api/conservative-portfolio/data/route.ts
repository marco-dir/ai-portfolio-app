...
// Conservative Portfolio Sheet ID
const SHEET_ID = '1UXwXsjBtdFnDgq8n6wcwF3djDbtaLSowYwbzlPUIG-0'
...
export async function GET(request: Request) {
    ...
    try {
        ...
        console.log(`[Conservative Portfolio] Fetching CSV from: ${csvUrl}`)
        ...
        if (!response.ok) {
            console.error(`[Conservative Portfolio] Fetch failed with status: ${response.status}`)
        ...
        console.log('[Conservative Portfolio] Headers:', headers)
        ...
        console.error('[Conservative Portfolio] API Error:', error)
